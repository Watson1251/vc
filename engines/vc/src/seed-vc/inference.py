...
def main(args):
    ...
    #file_name = f"{source_name}_{target_name}_{length_adjust}_{diffusion_steps}_{inference_cfg_rate}.wav"
    if key is not None:
        file_name = f"{key}_cloned.wav"
    else:
        file_name = f"{source_name}_cloned.wav"        
    #file_name = "vc_" + file_name
    torchaudio.save(os.path.join(args.output, file_name), vc_wave.cpu(), sr)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--key", type=str, default=None, help="Key for secure interface")
