...
export class SidebarComponent {
  ...
  allow(item: MenuItem): boolean {
    // show setup only if DEVICES_READ
    // if (item.link === 'setup') return this.perms.hasKey('DEVICES_READ');
    // if (item.link === 'libraries') return this.perms.hasKey('LIBRARIES_READ');
    return true;
  }
