 ...
 */
  ...
  fileChange(event: any) {
    ...
    console.log(this.customerForm.controls['img'])
  ...
  deleteCustomer() {
    this.store.dispatch(deletecustomerData({ id: this.deleteId.toString() }));
  ...
  filterdata() {
    if (this.term) {
      this.customers = this.Customerlist.filter((el: any) => el.email.toLowerCase().includes(this.term.toLowerCase()))
    } else {
