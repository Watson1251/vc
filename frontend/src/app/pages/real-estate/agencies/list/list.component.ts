 ...
 */
    ...
    setTimeout(() => {
      ...
      this.store.select(selectData).subscribe((data) => {
        ...
        this.agency = this.agencylist.slice(0, 10)
      });
  ...
  confirmDelete() {
    this.store.dispatch(deleteAgenciesData({ id: this.deleteID }));
  ...
  //     if (this.customerData[i].isSelected == true) {
  //       result = this.customerData[i].id;
  //       checkedVal.push(result);
  //     }
  //   }
  //   this.checkedValGet = checkedVal;
